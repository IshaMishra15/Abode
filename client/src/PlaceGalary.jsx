            ...
            <div className='absolute inset-0 bg-black min-h-screen overflow-auto text-white '>
                <div className='p-8 grid gap-4'>
                    <div>
                        ...
                        }} className='bg-primary text-white right-16 top-8 flex gap-1 py-2 px-4 rounded-2xl fixed shadow shadow-black'>
                    ...
                    {place?.photos?.length > 0 && place.photos.map(photo => (
                        <div key={photo}>
                            <img className='object-cover h-full w-full' src={'http://localhost:4000/uploads/' + photo} alt="" />
                        </div>
                    ))}
                </div>
            </div>
